...
{
    /*search through a1 looking for a2[0]
		if you find it, increment a2 and search through a1 for a2
		for each time you find a2 in a1, search through the remainder of a1 for a2+1, etc
		if you find the last element in a2, return 1; else return 0    */
	int count = 0;
	if (n2 <= 0)
		return 1;
	if (n1 <= 0)
...
void order(double a[], int n)
{
	...
	int half = (n/2) - ((n%2)/2);
	int firstNotGreater;
	int firstLess; //used to call divide

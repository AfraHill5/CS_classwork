#ifndef NEWBAG_H_DEFINED
#define NEWBAG_H_DEFINED
...
class Bag
    {
      public:
		...
		Bag& operator=(const Bag& a); //operator

		Bag(int size = DEFAULT_MAX_ITEMS); //Create a new bag with a set size.
   ...
   //iteration functions
	...
	private:
		BagItem* m_bag; //actually holds the data members of the bag

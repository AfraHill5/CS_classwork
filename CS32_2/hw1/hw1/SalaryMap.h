...
class SalaryMap
{
    ...
    bool add(std::string name, double salary);
        ...
        // and there is room in the map, add an entry for that employee and
        // salary and return true.  Otherwise make no change to the map and
        // return false.
    ...
    int size() const;  // Return the number of employeess in the SalaryMap.
